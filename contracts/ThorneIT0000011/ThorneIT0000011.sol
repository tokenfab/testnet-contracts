...
contract ThorneIT0000011 is ERC721PresetMinterPauserAutoId, Ownable {
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIdCounter;
    uint256 private _maxSupply = 287;
    
    constructor ()
        ERC721PresetMinterPauserAutoId(
          "Kadikoy/Kosuyolu Huzur Rezidansi, A Blok 37/3",
          "THN0000011",
          "https://terramirum.com/kadkoykosuyolu-huzur-rezidans-a-blok-373"
        )
    {}
